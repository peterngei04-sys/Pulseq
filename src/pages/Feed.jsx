...
const hoursAgo =
(Math.floor((Date.now() - new Date(p.created_at)) / 1000) / 3600) + 2;

/* Ranking score */
const score = (upvotes + comments + 2) / hoursAgo;
...
{comments[post.id]?.map(c => (
  <div key={c.id} className="comment-item" style={{ marginLeft: c.parent_id ? "25px" : "0" }}>
